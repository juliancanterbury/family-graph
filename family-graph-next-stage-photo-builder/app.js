...
let people=[], selected=null, scale=.75;
...
async function uploadOriginal(file){
  ...
  await client.from("photos").insert({id:photoId,original_filename:file.name,original_storage_path:originalPath,original_mime_type:file.type,original_size_bytes:file.size,processing_status:"uploaded"});
  ...
  alert("Original uploaded. Next: automatic large/medium/thumb/tiny/faces.");
}
